...
function xt(t, l, r, i, c, o, f = null, s = 0) {
...
function Se(t, l, r, i, c, o, f, s, d = {}) {
  const h = d.scales ?? null, v = d.rotationRad ?? 0, w = xt(t, l, c, o, f, s, h, v), D = xt(r, i, c, o, f, s, h, v);
  if (!w || !D) return null;
  let C = w.ra - D.ra;
...
async function Ue({ model: t, el: l }) {
  ...
  try {
    let pe = function() {
      At && clearTimeout(At), Dt = !0, At = setTimeout(() => {
        Dt = !1;
      }, 500);
    }, lt = function() {
      ...
      bt = n, O.style.cssText = n === "pan" ? D : w, z.style.cssText = n === "boxzoom" ? D : w, h.style.cursor = n === "pan" ? "grab" : "crosshair";
    }, Nt = function() {
      if (!tt) return;
      const n = Fe(tt, Kt, Zt);
      e.activeTexture(e.TEXTURE0), e.bindTexture(e.TEXTURE_2D, wt), e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, J, Q, 0, e.RGBA, e.UNSIGNED_BYTE, n);
    }, K = function() {
      ...
      o && (Lt(), G()), e.viewport(0, 0, h.width, h.height), e.clearColor(0, 0, 0, 0), e.clear(e.COLOR_BUFFER_BIT), e.enable(e.BLEND), e.blendFunc(e.ONE, e.ONE_MINUS_SRC_ALPHA), e.useProgram(F), e.uniform1i(x.u_image, 0), e.uniform1i(x.u_cmap, 1), e.uniform2f(x.u_crval, q[0], q[1]), e.uniform2f(x.u_cdelt, Tt[0], Tt[1]), e.uniform2f(x.u_crpix, Et[0], Et[1]), e.uniform2f(x.u_imageSize, J, Q), e.uniform2f(x.u_viewCenter, T, E);
      const n = ut();
      e.uniform2f(x.u_viewScale, n.scaleX, n.scaleY), e.uniform1f(x.u_viewRotation, k), e.uniform1f(x.u_fov, _), e.uniform1f(x.u_opacity, $t), e.uniform1i(x.u_stretch, Jt), e.uniform1i(x.u_showGrid, Qt);
      let u = -999, a = -999;
      if (st > -900)
        u = st, a = St;
      else if (ot > -900) {
      ...
      tt = null, J = 1, Q = 1, e.activeTexture(e.TEXTURE0), e.bindTexture(e.TEXTURE_2D, wt), e.texImage2D(
        e.TEXTURE_2D,
        0,
        e.RGBA,
        1,
      ...
      Q = u[0], J = u[1], tt = new Float32Array(n.buffer.slice(n.byteOffset, n.byteOffset + a)), r("Image: " + J + "x" + Q + ", " + tt.length + " floats"), Nt();
    }, Z = function() {
      const n = t.get("crval"), u = t.get("cdelt"), a = t.get("crpix");
      n && (q = [n[0] * g, n[1] * g]), u && (Tt = [u[0] * g, u[1] * g]), a && (Et = [a[0], a[1]]);
    }, Ut = function() {
      ...
      typeof n != "number" || typeof u != "number" || n < -900 || u < -900 ? (ot = -999, ct = -999) : (ot = n * g, ct = u * g, st = -999, St = -999);
    }, te = function() {
      U(), ft(), Z(), _e(), Vt(), b();
    }, Yt = function({ pushToAladin: n = !1 } = {}) {
      if (o && (n ? rt() : (It(), I = null, G())), b(), t.get("overlay_view_lock")) {
      ...
      var yt;
      const m = (yt = o == null ? void 0 : o.view) == null ? void 0 : yt.wasm;
      if (!(m != null && m.goFromTo)) return !1;
      let { x: A, y: M } = ht(n, u), { x: R, y: X } = ht(a, p);
      t.get("invert_horizontal_pan") === !1 && ([A, R] = [R, A]), m.goFromTo(A, M, R, X), o.view.updateCenter();
      const [L, it] = o.getRaDec();
      return T = L * g, E = it * g, Lt(), !0;
    }, ne = function() {
      gt++, te();
      const n = t.get("image_data");
      if (n && (n.byteLength || n.length) > 0) {
        r("Data arrived after " + gt + " poll(s)"), requestAnimationFrame(b), Rt = T, Ct = E, Mt = _;
        return;
      }
      gt < ee ? setTimeout(ne, Math.min(100 * Math.pow(1.5, gt - 1), 1e3)) : (r("No image data after " + ee + " polls — waiting for change event"), rt(), Rt = T, Ct = E, Mt = _);
    }, zt = function(n, u) {
    ...
    e.activeTexture(e.TEXTURE0), e.bindTexture(e.TEXTURE_2D, wt), e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, 1, 1, 0, e.RGBA, e.UNSIGNED_BYTE, new Uint8Array([0, 0, 0, 255])), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, e.NEAREST), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, e.NEAREST), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE);
    let J = 1, Q = 1, tt = null, q = [0, 0], Tt = [1, 1], Et = [0, 0], T = 0, E = 0, _ = Math.PI, I = null, k = 0, Kt = 0, Zt = 1, $t = 1, Jt = 0, Qt = 1, j = !1, et = !1, nt = !1, Dt = !1, At = null, ot = -999, ct = -999, st = -999, St = -999;
    const ge = { linear: 0, log: 1, sqrt: 2, asinh: 3 };
    let bt = "pan", Rt = 0, Ct = 0, Mt = Math.PI, V = 0, Y = 0;
    Ft("pan"), O.addEventListener("click", () => Ft("pan")), z.addEventListener("click", () => Ft("boxzoom")), B.addEventListener("click", () => {
      T = Rt, E = Ct, _ = Mt, lt(), rt(), b();
    });
    let Bt = !1;
    if (t.on("change:image_data", () => {
      ...
      U(), ft(), Z(), t.get("overlay_view_lock") || (Pt() ? (Ut(), o && rt()) : (I = null, o && G())), dt();
    ...
    const ee = 30;
    setTimeout(ne, 50);
    let pt = 0, mt = 0, _t = 0, vt = 0, Ot = !1;
    h.style.cursor = "grab", h.addEventListener("mousedown", (n) => {
      if (_t = n.clientX, vt = n.clientY, Ot = !1, bt === "boxzoom") {
        nt = !0;
        ...
        et = !0, pt = n.clientX, mt = n.clientY, h.style.cursor = "grabbing";
    }), window.addEventListener("mousemove", (n) => {
      if (et && !j) {
        if (Math.sqrt((n.clientX - _t) ** 2 + (n.clientY - vt) ** 2) < 3) return;
        et = !1, j = !0;
      }
      if (nt) {
      ...
      if (!j) {
        const m = h.getBoundingClientRect(), A = (n.clientX - m.left) / m.width * 2 - 1, M = -((n.clientY - m.top) / m.height * 2 - 1), R = K(), X = xt(
          A,
          M,
          T,
          E,
      ...
      const u = K(), a = ut();
      if (!ve(pt, mt, n.clientX, n.clientY)) {
        const m = zt(pt, mt), A = zt(n.clientX, n.clientY), M = Se(
          m.x,
          m.y,
          A.x,
          A.y,
      ...
      o && G(), pt = n.clientX, mt = n.clientY, Ot = !0, requestAnimationFrame(b);
    }), window.addEventListener("mouseup", (n) => {
      if (nt) {
        if (nt = !1, S.style.display = "none", Math.sqrt((n.clientX - _t) ** 2 + (n.clientY - vt) ** 2) < 5) return;
        ...
        _ = 2 * Math.asin(Math.min(1, X * Math.sin(L))), _ = Xt(_), lt(), Yt({ pushToAladin: !0 });
        return;
      }
      if (j || et)
        if (j = !1, et = !1, h.style.cursor = bt === "pan" ? "grab" : "crosshair", Math.sqrt((n.clientX - _t) ** 2 + (n.clientY - vt) ** 2) < 3) {
          ...
          try {
            ...
            if (o != null && o.pix2world) {
              const ce = ht(n.clientX, n.clientY), at = o.pix2world(ce.x, ce.y);
          ...
          const A = a.ra - q[0], M = Math.sin(a.dec), R = Math.cos(a.dec), X = Math.sin(q[1]), L = Math.cos(q[1]), it = R * Math.sin(A), yt = M * L - R * X * Math.cos(A);
          t.set("clicked_lm", [it, yt]);
          const oe = t.get("click_tick");
          t.set("click_tick", (oe ?? 0) + 1), t.save_changes(), st = -999, St = -999, ot = a.ra, ct = a.dec, o && kt(), requestAnimationFrame(b);
        } else
          lt(), Yt({ pushToAladin: !1 });
    }), h.addEventListener("wheel", (n) => {
      n.preventDefault(), _ *= n.deltaY > 0 ? 1.1 : 1 / 1.1, _ = Xt(_), lt(), o ? (o.setFoV(_ / g), requestAnimationFrame(() => Yt({ pushToAladin: !1 }))) : requestAnimationFrame(b);
